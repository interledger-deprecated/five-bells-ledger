define({ "api": [
  ...
  {
    "type": "get",
    "url": "/subscriptions/:subscription_id/notifications/:notification_id",
    "title": "Get RESThook notification",
    "name": "GetNotification",
    "group": "Notification",
    "version": "1.0.0",
    "description": "<p>Use this to query about the details of a notification. Only accounts that were related to the notification event are authorized.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Subscription <a href=\"http://en.wikipedia.org/wiki/Universally_unique_identifier\">UUID</a>.</p>"
          }
        ]
      }
    },
    "examples": [
      {
        ...
        "content": "curl -x GET -H \"Authorization: Basic QWxhZGRpbjpPcGVuU2VzYW1l\" http://usd-ledger.example/USD/subscriptions/f49697a6-d52c-4f46-84c8-9070a31feab7/notifications/89ae630b-959a-47cc-adcf-d7be85e310c0",
        "type": "shell"
      }
    ],
    "success": {
      "examples": [
        {
          "title": "200 Notification Response:",
  ...
  },
  {
    ...
    "group": "Subscription",
    "version": "1.0.0",
    "description": "<p>End a subscription.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "filename": "src/controllers/subscriptions.js",
  ...
  },
  {
    "type": "get",
    "url": "/subscriptions/:id",
    "title": "Get RESThook subscription",
    "name": "GetSubscription",
    "group": "Subscription",
    "version": "1.0.0",
    "description": "<p>Use this to query about the details or status of a subscription.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "examples": [
      {
        ...
        "content": "curl -x GET -H \"Authorization: Basic QWxhZGRpbjpPcGVuU2VzYW1l\" http://usd-ledger.example/USD/subscriptions/f49697a6-d52c-4f46-84c8-9070a31feab7",
        "type": "shell"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "group": "Subscription",
    "version": "1.0.0",
    "description": "<p>Note that the format of the notification <code>POST</code>ed to the <code>target</code> is the same as what is returned from <code>GET /subscriptions/:subscription_id/notifications/:notification_id</code></p>",
    "parameter": {
      "examples": [
        {
