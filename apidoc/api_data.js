define({ "api": [
  ...
  {
    "type": "get",
    "url": "/transfers/byExecutionCondition/:execution_condition",
    "title": "Get Transfers by Condition",
    "name": "GetTransferByExecutionCondition",
    "group": "Transfer_Methods",
    "version": "15.0.0",
    "description": "<p>Use this to query about the details or status of a local transfer that is using atomic mode.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "examples": [
      {
        "title": "Get a transfer",
        "content": "curl -X GET http://usd-ledger.example/transfers/ByExecutionCondition/cc:0:3:8ZdpKBDUV-KX_OnFZTsCWB_5mlCFI3DynX5f5H2dN-Y:2",
        "type": "shell"
      }
    ],
    "success": {
        ...
        "Success": [
          {
            ...
            "optional": false,
            "field": "Array",
            "description": "<p>Array of <a href=\"#transfer_object\">Transfer objects</a> matching the condition.</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "Array of Transfer responses:",
          "content": "HTTP/1.1 200 OK\n[{\n  \"id\": \"http://usd-ledger.example/transfers/3a2a1d9e-8640-4d2d-b06c-84f2cd613204\",\n  \"ledger\": \"http://usd-ledger.example\",\n  \"debits\": [{\n    \"account\": \"http://usd-ledger.example/accounts/alice\",\n    \"amount\": \"50\"\n  }],\n  \"credits\": [{\n    \"account\": \"http://usd-ledger.example/accounts/bob\",\n    \"amount\": \"50\"\n  }],\n  \"execution_condition\": \"cc:0:3:8ZdpKBDUV-KX_OnFZTsCWB_5mlCFI3DynX5f5H2dN-Y:2\",\n  \"expires_at\": \"2015-06-16T00:00:01.000Z\",\n  \"state\": \"executed\",\n  \"timeline\": {\n    \"proposed_at\": \"2015-06-16T00:00:00.000Z\",\n    \"prepared_at\": \"2015-06-16T00:00:00.500Z\",\n    \"executed_at\": \"2015-06-16T00:00:00.999Z\"\n  }\n}]",
          "type": "Array"
        }
      ]
